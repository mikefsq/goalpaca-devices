...
// Selection is by index; the serial arg is currently ignored (the EAF exposes no USB
// serial-number descriptor and its flash serial decode is not yet implemented).
